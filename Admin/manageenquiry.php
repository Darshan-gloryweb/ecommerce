<?php include "db.php";
	...
	if(isset($_POST['cbx']))
	{
		...
		{	
			$sql2="delete from enquiry where id=".$ids[$i]; 
    ...
    $sql = "Select * from enquiry order by createdon DESC";
    $r = mysqli_query($dbLink,$sql) or die("can not select enquiry");
          ...
          <?php  include('inc_leftmenu.php'); ?>          
            ...
            <div id="content">
                <div class="inner">
                    ...
                    <div class="onecolumn" >
                    <div class="header">
                    <span ><span class="ico  gray random"></span> Enquiry</span>
                    </div><!-- End header -->	
                    <div class=" clear"></div>
                    <div class="content" >
  ...
  document.feedbackform.submit();
   return false" />
                  <!--  <div style="position:absolute;margin-left:70px;"><a href="viewfeedback.php" class="uibutton icon confirm add" >View Feedback</a></div>-->
					<div class="tableName">
                    <table class="display data_tableenquiry" id="Enquiry">
                                <thead>
                                  <tr>
								...
								{ ?>
                                    ...
                                    <td align="left"><?php  echo $data['createdon']; ?></td>
                                    <td align="left"><?php  if($data['status']==1) { echo "Active";} else { echo "Inactive";}; ?></td>       
                                    <td align="left">
                                     
                                      <span class="tip" >
                                          <a  title="View" href="viewenquiry.php?id=<?php  echo $data['id'];?>" >
