<?php include "db.php";
    ...
    $r = mysqli_query($dbLink,$sql) or die("can not select social media");	
?>
...
<head>
          ...
          <?php  include('inc_leftmenu.php'); ?>          
            ...
            <div id="content">
                <div class="inner">
                    ...
                    <?php 
					include("sec.php");
					 $right=user_right('socialmedia.php');
					 if($right==false)
					 {
						 ?>
                         <div class="onecolumn" >
 ...
 <div class="section "><div align="center" style="font-weight:bold; color:#060;"><?php  if(isset($_GET['msg'])){ echo $_GET['msg']; } ?></div></div>
                    <div class="onecolumn" >
                    <div class="header">
                    <span ><span class="ico  gray spreadsheet"></span> Social Media Settings </span>
                    </div><!-- End header -->	
                    <div class=" clear"></div>
                    <div class="content" >
                            ...
                            <form action="socialmediap.php" method="post" name="form1" id="form1" onSubmit="return validate(this);"> 
                            ...
                            <div  class="grid3">
									...
									<div class="section ">
                                    <label><?=ucwords($data['name'])?><small>Text</small></label>   
                                    <div> 
                                    <input type="text" class="large" name="<?=$data['name']?>_url"  id="<?=$data['name']?>_url" value="<?=$data['url']?>">
                                    <input type="checkbox" name="<?=$data['name']?>_act" id="<?=$data['name']?>_act" value="Yes" class="ck" <?php  if($data['status']=='Yes'){ echo "checked='checked'"; } ?> />
                                        <label for="<?=$data['name']?>_act">Activation</label>
                                    </div>
                                    </div>
                                    <?php  } ?>
