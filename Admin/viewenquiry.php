...
{
	$action = "E";
    $sqledit = "Select * from enquiry where id=".$id;
    $editres = mysqli_query($dbLink,$sqledit) or die("can not select enquiry");
...
<div id="content">
  <div class="inner">
    ...
    <div class="onecolumn" >
      ...
      <div class=" clear"></div>
      <div class="content" >
        <div style="margin-bottom:10px;"><a href="manageenquiry.php" class="uibutton icon confirm answer" >Back</a></div>
