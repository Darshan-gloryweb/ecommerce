jQuery( document ).ready(function($) {
	...
	if($('input[name="is_deal_pro"]').prop("checked") == true){

		

		 $('.discount_lable1').show();
	...
	if($('input[name="is_deal_cat"]').prop("checked") == true){
	...
	$('input[name="cr_status"]').click(function(){
		...
		$.ajax({
					...
					url: "crstatus_update.php",

					data:'crid= ' + crid + '&crstatus='+crstatus,
	...
	$('input[name="is_deal_pro"]').click(function(){
	...
	$( ".discount_lable1" ).focusout(function() {
			if($(this).val()>100){
				alert('Please Enter valid % of Discount.');
				$("input[name=discount_lable]").val('');
				$("input[name=SalePrice]").val('');
			}
			var Price = $("input[name=Price]").val();
			var discount_lable1 = $(this).val();
			var disprice = (Price *discount_lable1) / 100;
			//alert(saleprice);
			var saleprice = Price -disprice; 
			$("input[name=SalePrice]").val(saleprice);	
				
				
	});
	$( ".real_Price" ).focusout(function() {
			//alert('zalak');
			var Price = $(this).val();
			var discount_lable1 = ("input[name=discount_lable]").val();
			//alert(discount_lable1);
			var disprice = (Price *discount_lable1) / 100;
			//alert(saleprice);
			var saleprice = Price -disprice; 
			$("input[name=SalePrice]").val(saleprice);	
	...
	$('input[name="is_deal_cat"]').click(function(){
	...
	$('.view_btn').click(function(){
		...
		$.ajax({
					...
					url: "cr_review_responce.php",

					data:'crid= ' + crid,

					success: function(res){

							$(".cus_name").html(res.fullname);

							//$(".cus_rating").html(res.ratings);

							var starNumber = res.ratings;

							var x;

							for(x=1;x<=starNumber;x++) {

								$(".cus_rating").append('<span class="fa fa-star checked"></span>');
							...
							while (x<=5) {
								...
								$(".cus_rating").append('<span class="fa fa-star"></span>');
...

{
    ...
    $('label[for='+ar+']').addClass('checked ');

});

});

$(".alldu").live('click',function()

{
    ...
    $('label[for='+ar+']').removeClass('checked ');
...

{
	...
	var dname=name.substr(0,pos);

	var table=name.substr(pos+1);

	$.confirm({

'title': '_DELETE DIALOG BOX','message': " <strong>YOU WANT TO DELETE </strong><br /><font color=red>' "+ dname +" ' </font> ",'buttons': {'Yes': {'class': 'special',
			...
			loading('Checking');
							...
							xmlhttp.onreadystatechange=function()

  							{
								...
								if(xmlhttp.responseText == "Use"){

									showError("This category Already Have Products..");
								...
								if(xmlhttp.responseText == "In Use"){

									showError("It is used in some product.");
...

						{
							...
							xmlhttp.open("GET","menusettingsp.php?id="+id,true);
...

						{
							...
							xmlhttp.open("GET","managepagep.php?id="+id,true);
...

						{
							...
							xmlhttp.open("GET","manageauthorp.php?id="+id,true);
...

						{
							...
							xmlhttp.open("GET","managenavigationp.php?id="+id,true);
...

						{
							...
							xmlhttp.open("GET","userp.php?id="+id,true);

						}

						else if(table=="homebanner")

						{

							xmlhttp.open("GET","addhomebannerp.php?id="+id,true);
...

						{
							...
							xmlhttp.open("GET","managecontactp.php?id="+id,true);
...

						{
							...
							xmlhttp.open("GET","addcategoryp.php?id="+id,true);

						}

						else if(table=="categorytype")

						{

							xmlhttp.open("GET","addcategorytypep.php?id="+id,true);
...

						{
							...
							xmlhttp.open("GET","viewfeedbackp.php?id="+id,true);
...

						{
							...
							xmlhttp.open("GET","addproductp.php?id="+id,true);

						}

						else if(table=="crreview")

						{

							xmlhttp.open("GET","crreviewp.php?id="+id,true);
...

						{
							...
							xmlhttp.open("GET","addbrandp.php?id="+id,true);

						}
						
						else if(table=="data_tableattributetable")

						{

							xmlhttp.open("GET","addattributesp.php?id="+id,true);

						}
						
						else if(table=="data_tablevariation")
						...
						else if(table=="imagegallery")

						{

							xmlhttp.open("GET","addproductimagep.php?id="+id,true);

						}

						else if(table=="advertisegallery")

						{

							xmlhttp.open("GET","addadvertiseimagep.php?id="+id,true);

						}

						else if(table=="advertisebanner")

						{

							xmlhttp.open("GET","addadvertisebannerp.php?id="+id,true);
...

						{
							...
							xmlhttp.open("GET","customerp.php?id="+id,true);
...

						{
							...
							xmlhttp.open("GET","addproductquantityp.php?id="+id,true);
...

						{
							...
							xmlhttp.open("GET","addgiftcertificatep.php?id="+id,true);
...
$(document).ready(function(){	
	...
	"sPaginationType": "full_numbers",
	 ...
	 "aaSorting": [],
	  ...
	  "aoColumns": [
					...
					{ "bSortable": false },null,null,{ "bSortable": false },null,{ "bSortable": false },{ "bSortable": false }
	...
	"sPaginationType": "full_numbers",
	 ...
	 "aaSorting": [],
	  ...
	  "aoColumns": [
					...
					{ "bSortable": false },null,{ "bSortable": false },{ "bSortable": false },null,null,null,{ "bSortable": false }

	  ]

	});

	$('.data_tablecustgift').dataTable({
	...
	"sPaginationType": "full_numbers",
	 ...
	 "aaSorting": [],
	  ...
	  "aoColumns": [
					...
					{ "bSortable": false },null,{ "bSortable": false },{ "bSortable": false },{ "bSortable": false },null,null,null,{ "bSortable": false }
	...
	"sPaginationType": "full_numbers",
	 ...
	 "aaSorting": [],
	  ...
	  "aoColumns": [
					...
					null,null,null,null,null,null,{ "bSortable": false },null,{ "bSortable": false }

	  ]

	});

	$('.data_tablevariant').dataTable({
 ...
 $('.data_productvariantvalue').dataTable({
 ...
 "sPaginationType": "full_numbers",
  ...
  "aaSorting": [],
   ...
   "aoColumns": [
	...
	"sPaginationType": "full_numbers",
	 ...
	 "aaSorting": [],
	  ...
	  "aoColumns": [
					...
					{ "bSortable": false },null,null,{ "bSortable": false },null,{ "bSortable": false }
	...
	$('.data_tableattributetable').dataTable({
	...
	$('.data_advertisebanner').dataTable({
	...
	$('.data_tablecategorytype').dataTable({
 ...
 "sPaginationType": "full_numbers",
  ...
  "aaSorting": [],
   ...
   "aoColumns": [
     ...
     { "bSortable": false },null,{ "bSortable": false },null,{ "bSortable": false },{ "bSortable": false },{ "bSortable": false },{ "bSortable": false }
 ...
 "sPaginationType": "full_numbers",
  ...
  "aaSorting": [],
   ...
   "aoColumns": [
     ...
     { "bSortable": false },null,{ "bSortable": false },{ "bSortable": false },null,{ "bSortable": false },{ "bSortable": false },{ "bSortable": false },{ "bSortable": false }
	...
	"sPaginationType": "full_numbers",
	 ...
	 "aaSorting": [],
	  ...
	  "aoColumns": [
					...
					{ "bSortable": false },{ "bSortable": false },null,null,{ "bSortable": false },null,{ "bSortable": false }
 ...
 "sPaginationType": "full_numbers",
  ...
  "aaSorting": [],
   ...
   "aoColumns": [
	...
	"sPaginationType": "full_numbers",
	 ...
	 "aaSorting": [],
	  ...
	  "aoColumns": [
					...
					null,null,null,{ "bSortable": false },null,{ "bSortable": false }
	...
	"sPaginationType": "full_numbers",
	 ...
	 "aaSorting": [],
	  ...
	  "aoColumns": [
					...
					null,null,{ "bSortable": false },null,{ "bSortable": false }
	...
	"sPaginationType": "full_numbers",
	 ...
	 "aaSorting": [],
	  ...
	  "aoColumns": [
					...
					null,{ "bSortable": false },{ "bSortable": false },null,null,{ "bSortable": false }
	...
	$('.data_tablespecialization').dataTable({
	...
	"sPaginationType": "full_numbers",
	 ...
	 "aaSorting": [],
	  ...
	  "aoColumns": [
					...
					{ "bSortable": false },{ "bSortable": false },null,null,null,{ "bSortable": false }

	  ]

	});

	$('.data_emailtemplate').dataTable({
	...
	$('.data_tablenavigation').dataTable({
	...
	"sPaginationType": "full_numbers",
	 ...
	 "aaSorting": [],
	  ...
	  "aoColumns": [
					...
					null,{ "bSortable": false },null,{ "bSortable": false },{ "bSortable": false }

	  ]

	});

	$('.data_author').dataTable({
	...
	"sPaginationType": "full_numbers",
	 ...
	 "aaSorting": [],
	  ...
	  "aoColumns": [
					...
					{ "bSortable": false },null,null,{ "bSortable": false },{ "bSortable": false }
	...
	"sDom": 'fCl<"clear">rtip',
	 ...
	 "aaSorting": [],
	  ...
	  "aoColumns": [
					...
					{ "bSortable": false },null,{ "bSortable": false },null,null,null,{ "bSortable": false }
	...
	"sPaginationType": "full_numbers",
	 ...
	 "aaSorting": [],
	  ...
	  "aoColumns": [
					...
					{ "bSortable": false },{ "bSortable": false },null,{ "bSortable": false },{ "bSortable": false },null,{ "bSortable": false }
